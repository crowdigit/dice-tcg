...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    public void AddCard(){
        ...
        insert_data = "insert into urCardDB values('" + name + "'," + HP + "," + AC + "," + SC + "," + MC + "," + DiceTop + "," + DiceBottom + "," + DiceMax + ");";
        ...
        name = "raflecia"; HP = 1600; AC = 300; SC = 1; MC = 2; DiceTop = 1300; DiceBottom = 1100; DiceMax = 3;
        insert_data = "insert into urCardDB values('" + name + "'," + HP + "," + AC + "," + SC + "," + MC + "," + DiceTop + "," + DiceBottom + "," + DiceMax + ");";
        db.execSQL(insert_data);
